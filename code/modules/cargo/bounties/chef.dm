...
/datum/bounty/item/chef/icecreamsandwich
	...
	required_count = 3
	wanted_types = list(
		/obj/item/food/icecreamsandwich = TRUE,
	)
...
/datum/bounty/item/chef/strawberryicecreamsandwich
	...
	required_count = 3
	wanted_types = list(
		/obj/item/food/strawberryicecreamsandwich = TRUE,
	)
...
/datum/bounty/item/chef/carrotfries
	...
	required_count = 3
	wanted_types = list(
		/obj/item/food/carrotfries = TRUE,
	)
...
/datum/bounty/item/chef/superbite
	...
	reward = 12000
	wanted_types = list(
		/obj/item/food/burger/superbite = TRUE,
	)
...
/datum/bounty/item/chef/poppypretzel
	...
	reward = 3000
	wanted_types = list(
		/obj/item/food/poppypretzel = TRUE,
	)
...
/datum/bounty/item/chef/eggplantparm
	...
	required_count = 3
	wanted_types = list(
		/obj/item/food/eggplantparm = TRUE,
	)
...
/datum/bounty/item/chef/chawanmushi
	...
	reward = 8000
	wanted_types = list(
		/obj/item/food/chawanmushi = TRUE,
	)
...
/datum/bounty/item/chef/soylentgreen
	...
	reward = 5000
	wanted_types = list(
		/obj/item/food/soylentgreen = TRUE,
	)
